...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [2] = LAYOUT(
        KC_ESC, TO(3), KC_NUM, KC_TILD,  KC_F11,   
        KC_BSPC, KC_DEL, KC_PERCENT, KC_CIRC, KC_F12,   

        KC_PIPE, KC_AMPERSAND, KC_QUESTION, KC_EXLM, KC_HASH,                        
        KC_DOLLAR, KC_AT, KC_SCLN, KC_COLN, KC_BACKSLASH, 
